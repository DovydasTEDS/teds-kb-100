...
// Tap dance enums
enum {
    TD_ENCODER,  // Double tap to skip
};

// Tap dance actions
tap_dance_action_t tap_dance_actions[] = {
    [TD_ENCODER] = ACTION_TAP_DANCE_DOUBLE(KC_MPLY, KC_MNXT),  // Double tap = skip song
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_ESC  , KC_F1   , KC_F2   , KC_F3   , KC_F4   , KC_F5   , KC_F6   , KC_F7   , KC_F8   , KC_F9   , KC_F10  , KC_F11  , KC_F12  ,                   KC_PSCR , KC_SCRL , KC_PAUS ,       TD(TD_ENCODER) ,
